<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur border-b border-emerald-50 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center gap-6">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:flex">
                    ...
                    <x-nav-link :href="route('test-cases.index')" :active="request()->routeIs('test-cases.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('test-cases.index')" :active="request()->routeIs('test-cases.*')">
                {{ __('Przypadki testowe') }}
            </x-responsive-nav-link>
